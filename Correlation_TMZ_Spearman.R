...
##Correlation with TMZ AUC as response
...
#Run Spearman correlation analysis and do not correct for multiple testing
mat_x <- as.data.frame(mat)
output_none_TMZ_IC50 <- corr.test(mat_x, survival_TMZ_IC50, method = "spearman", adjust = "none")
output_none_TMZ_matrix_IC50 <- cbind(output_none_TMZ_IC50$ci, output_none_TMZ_IC50$ci.adj)
output_none_TMZ_matrix_IC50 <- output_none_TMZ_matrix_IC50[,-6]
colnames(output_none_TMZ_matrix_IC50)<-c("ci_lower", "Correlation_Coefficient_r","ci_upper","p_value","adjusted_ci_lower", "adjusted_ci_upper")
output_none_TMZ_matrix_IC50 <- output_none_TMZ_matrix_IC50[,c("ci_lower","ci_upper", "adjusted_ci_lower", "adjusted_ci_upper","Correlation_Coefficient_r","p_value")]

#Remove -srvvl from first column
Gene_name <- rownames(output_none_TMZ_matrix_IC50)
rownames(output_none_TMZ_matrix_IC50) <- NULL
output_none_TMZ_matrix_IC50 <- cbind(Gene_name,output_none_TMZ_matrix_IC50)
output_none_TMZ_matrix_IC50$Gene_name <-gsub("-srvvl","",as.character(output_none_TMZ_matrix_IC50$Gene_name))

#Run Spearman correlation analysis and correction for multiple testing using Benjamini Hochberg
mat_x <- as.data.frame(mat)
output_TMZ_IC50 <- corr.test(mat_x, survival_TMZ_IC50, method = "spearman", adjust = "BH")
output_TMZ_matrix_IC50 <- cbind(output_TMZ_IC50$ci, output_TMZ_IC50$ci.adj)
output_TMZ_matrix_IC50 <- output_TMZ_matrix_IC50[,-6]
colnames(output_TMZ_matrix_IC50)<-c("ci_lower", "Correlation_Coefficient_r","ci_upper","adjusted_p_value","adjusted_ci_lower", "adjusted_ci_upper")
output_TMZ_matrix_IC50 <- output_TMZ_matrix_IC50[,c("ci_lower","ci_upper", "adjusted_ci_lower", "adjusted_ci_upper","Correlation_Coefficient_r","adjusted_p_value")]

#Remove -srvvl from first column
Gene_name <- rownames(output_TMZ_matrix_IC50)
rownames(output_TMZ_matrix_IC50) <- NULL
output_TMZ_matrix_IC50 <- cbind(Gene_name,output_TMZ_matrix_IC50)
output_TMZ_matrix_IC50$Gene_name <-gsub("-srvvl","",as.character(output_TMZ_matrix_IC50$Gene_name))
...
output_none_TMZ_matrix_AUC <- cbind(output_none_TMZ_AUC$ci, output_none_TMZ_AUC$ci.adj)
output_none_TMZ_matrix_AUC <- output_none_TMZ_matrix_AUC[,-6]
colnames(output_none_TMZ_matrix_AUC)<-c("ci_lower", "Correlation_Coefficient_r","ci_upper","p_value","adjusted_ci_lower", "adjusted_ci_upper")
output_none_TMZ_matrix_AUC <- output_none_TMZ_matrix_AUC[,c("ci_lower","ci_upper", "adjusted_ci_lower", "adjusted_ci_upper","Correlation_Coefficient_r","p_value")]

#Remove -srvvl from first column
Gene_name <- rownames(output_none_TMZ_matrix_AUC)
rownames(output_none_TMZ_matrix_AUC) <- NULL
output_none_TMZ_matrix_AUC <- cbind(Gene_name,output_none_TMZ_matrix_AUC)
output_none_TMZ_matrix_AUC$Gene_name <-gsub("-srvvl","",as.character(output_none_TMZ_matrix_AUC$Gene_name)) 

#Run Spearman correlation analysis and correction for multiple testing using Benjamini Hochberg
mat_x <- as.data.frame(mat)
output_TMZ_AUC <- corr.test(mat_x, survival_TMZ_AUC, method = "spearman", adjust = "BH")
output_TMZ_matrix_AUC <- cbind(output_TMZ_AUC$ci, output_TMZ_AUC$ci.adj)
output_TMZ_matrix_AUC <- output_TMZ_matrix_AUC[,-6]
colnames(output_TMZ_matrix_AUC)<-c("ci_lower", "Correlation_Coefficient_r","ci_upper","adjusted_p_value","adjusted_ci_lower", "adjusted_ci_upper")
output_TMZ_matrix_AUC <- output_TMZ_matrix_AUC[,c("ci_lower","ci_upper", "adjusted_ci_lower", "adjusted_ci_upper","Correlation_Coefficient_r","adjusted_p_value")]

#Remove -srvvl from first column
Gene_name <- rownames(output_TMZ_matrix_AUC)
rownames(output_TMZ_matrix_AUC) <- NULL
output_TMZ_matrix_AUC <- cbind(Gene_name,output_TMZ_matrix_AUC)
output_TMZ_matrix_AUC$Gene_name <-gsub("-srvvl","",as.character(output_TMZ_matrix_AUC$Gene_name))
...
##Correlation with TMZ 100uM as response
...
output_none_TMZ_matrix_100uM <- cbind(output_none_TMZ_100uM$ci, output_none_TMZ_100uM$ci.adj)
output_none_TMZ_matrix_100uM <- output_none_TMZ_matrix_100uM[,-6]
colnames(output_none_TMZ_matrix_100uM)<-c("ci_lower", "Correlation_Coefficient_r","ci_upper","p_value","adjusted_ci_lower", "adjusted_ci_upper")
output_none_TMZ_matrix_100uM <- output_none_TMZ_matrix_100uM[,c("ci_lower","ci_upper", "adjusted_ci_lower", "adjusted_ci_upper","Correlation_Coefficient_r","p_value")]

#Remove -srvvl from first column
Gene_name <- rownames(output_none_TMZ_matrix_100uM)
rownames(output_none_TMZ_matrix_100uM) <- NULL
output_none_TMZ_matrix_100uM <- cbind(Gene_name,output_none_TMZ_matrix_100uM)
output_none_TMZ_matrix_100uM$Gene_name <-gsub("-srvvl","",as.character(output_none_TMZ_matrix_100uM$Gene_name)) 

#Run Spearman correlation analysis and correction for multiple testing using Benjamini Hochberg
mat_x <- as.data.frame(mat)
output_TMZ_100uM <- corr.test(mat_x, survival_TMZ_100uM, method = "spearman", adjust = "BH")
output_TMZ_matrix_100uM <- cbind(output_TMZ_100uM$ci, output_TMZ_100uM$ci.adj)
output_TMZ_matrix_100uM <- output_TMZ_matrix_100uM[,-6]
colnames(output_TMZ_matrix_100uM)<-c("ci_lower", "Correlation_Coefficient_r","ci_upper","adjusted_p_value","adjusted_ci_lower", "adjusted_ci_upper")
output_TMZ_matrix_100uM <- output_TMZ_matrix_100uM[,c("ci_lower","ci_upper", "adjusted_ci_lower", "adjusted_ci_upper","Correlation_Coefficient_r","adjusted_p_value")]

#Remove -srvvl from first column
Gene_name <- rownames(output_TMZ_matrix_100uM)
rownames(output_TMZ_matrix_100uM) <- NULL
output_TMZ_matrix_100uM <- cbind(Gene_name,output_TMZ_matrix_100uM)
output_TMZ_matrix_100uM$Gene_name <-gsub("-srvvl","",as.character(output_TMZ_matrix_100uM$Gene_name))
